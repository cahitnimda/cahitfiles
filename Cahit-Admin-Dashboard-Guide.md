...
## 4. Card Manager — Add, Edit, Reorder & Delete Cards

### Overview
The **Card Manager** lets you fully control the project and service cards that appear on the website. You can add new cards, edit existing ones, change the display order, delete cards, and publish all changes to the live site — all from one screen.

### How to Open the Card Manager
1. Log in to the admin dashboard at `/admin`
2. Click **Card Manager** in the left sidebar (it has a monitor icon)
3. You will see two tabs at the top: **Projects** and **Services**
4. Click the tab for the type of card you want to manage

### How to Add a New Card
1. Open the **Card Manager**
2. Select the **Projects** or **Services** tab
3. Click the **"+ Add New Card"** button (top right)
4. A new blank card appears at the bottom of the list, and an edit form opens below
5. Fill in the card fields:

**For a new Project card:**
| Field | What to enter |
|---|---|
| Title | The project name (e.g., "Harbor Expansion") |
| Slug | The URL path — auto-generated from the title if left blank (e.g., `harbor-expansion`) |
| Description | A short summary shown on the card |
| Image URL | Paste an image URL, or click **Upload Image** to upload from your computer |
| Category Badge | A label shown on the card corner (e.g., "Marine", "Infrastructure") |
| Location | Where the project is located (e.g., "Muscat, Oman") |

**For a new Service card:**
| Field | What to enter |
|---|---|
| Title | The service name (e.g., "Structural Steel Works") |
| Slug | The URL path — auto-generated from the title if left blank |
| Description | A short summary shown on the card |
| Image URL | Paste an image URL, or click **Upload Image** to upload from your computer |
| Title (Arabic) | The Arabic translation of the service name |
| Description (Arabic) | The Arabic translation of the description |

6. Click **Save Card** to confirm the card details
7. Click **"Save & Publish"** to update the live website

> **Important:** The card is only saved locally until you click **"Save & Publish"**. Always click that button to push your changes to the live site.

### How to Edit an Existing Card
1. Open the **Card Manager** and select the correct tab (Projects or Services)
2. Find the card you want to edit in the list
3. Click the **pencil icon** (Edit) on the right side of that card
4. The edit form opens below the list — make your changes
5. Click **Save Card**, then click **"Save & Publish"**

### How to Reorder Cards
1. Find the card you want to move
2. Use the **up arrow** (▲) or **down arrow** (▼) buttons on the right side of the card
3. The card moves one position up or down in the list
4. Click **"Save & Publish"** to apply the new order on the live site

### How to Delete a Card
1. Find the card you want to remove
2. Click the **trash icon** (Delete) on the right side of the card
3. A confirmation prompt appears — click **OK** to confirm
4. Click **"Save & Publish"** to remove the card from the live site

### What Happens After You Add or Edit a Card
- Each card automatically gets a **"Read More"** link pointing to its detail page (e.g., `/projects/harbor-expansion`)
- You can customize the detail page content from the **Content Editor** (see below)
- If no detail page content has been added yet, the system uses the card's title, image, and description as placeholders

---

## 4b. Detail Page Content — Customizing "Read More" Pages

### Overview
When a visitor clicks "Read More" on any card, they are taken to a **detail page**. You can customize the content of each detail page from the Content Editor.

### How to Edit Detail Page Content
1. Go to **Content Editor** in the admin sidebar

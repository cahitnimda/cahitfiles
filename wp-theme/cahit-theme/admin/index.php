    ...
    <main class="admin-main">
      <header class="admin-header">
        ...
        <div class="header-actions">
          ...
          <div id="livePresencePill" class="live-presence-pill" data-testid="presence-pill" style="display:inline-flex;visibility:hidden;align-items:center;gap:8px;padding:6px 12px;background:#ecfdf5;border:1px solid #6ee7b7;border-radius:999px;font-size:12px;color:#065f46;margin-right:12px;cursor:pointer;position:relative" title="Click for details">
